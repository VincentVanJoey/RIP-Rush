...
partial class Styles : MonoGameGum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        ...
        global::MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(Styles)] = template;
    ...
    public ColoredRectangleRuntime DarkPrimary { get; protected set; }
    public ColoredRectangleRuntime Primary { get; protected set; }
    public ColoredRectangleRuntime LightPrimary { get; protected set; }
    public ColoredRectangleRuntime PrimaryGreen { get; protected set; }
    public ColoredRectangleRuntime PrimaryBlue { get; protected set; }
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        DarkPrimary = this.Visual?.GetGraphicalUiElementByName("DarkPrimary") as global::MonoGameGum.GueDeriving.ColoredRectangleRuntime;
        Primary = this.Visual?.GetGraphicalUiElementByName("Primary") as global::MonoGameGum.GueDeriving.ColoredRectangleRuntime;
        LightPrimary = this.Visual?.GetGraphicalUiElementByName("LightPrimary") as global::MonoGameGum.GueDeriving.ColoredRectangleRuntime;
        PrimaryGreen = this.Visual?.GetGraphicalUiElementByName("PrimaryGreen") as global::MonoGameGum.GueDeriving.ColoredRectangleRuntime;
        PrimaryBlue = this.Visual?.GetGraphicalUiElementByName("PrimaryBlue") as global::MonoGameGum.GueDeriving.ColoredRectangleRuntime;
