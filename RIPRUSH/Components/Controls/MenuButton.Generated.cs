//Code for Controls/MenuButton (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class MenuButton : global::MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/MenuButton");
        ...
        ElementSaveExtensions.RegisterGueInstantiation("Controls/MenuButton", () => 
        {
