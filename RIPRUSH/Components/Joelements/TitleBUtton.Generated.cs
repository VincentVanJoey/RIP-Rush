//Code for Joelements/TitleBUtton (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class TitleBUtton : global::MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Joelements/TitleBUtton");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new TitleBUtton(visual);
            return visual;
        });
        global::MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(TitleBUtton)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Joelements/TitleBUtton", () => 
        {
