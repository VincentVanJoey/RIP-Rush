...
namespace RIPRUSH.Components.Joelements {
    partial class ResultMenu {
        ...
        partial void CustomInitialize() {
            ...
            RetryTitleButton.Click += RetryTitleButton_Click;
        ...
        public void InitializeButtons() {
            _buttons = [RetryButton, RetryTitleButton];
            _focusedIndex = 0;
        ...
        private void RetryTitleButton_Click(object sender, System.EventArgs e) {
            Core.Audio.PlaySoundEffect(_uiSound);
            Core.Audio.PauseAudio();
